...
## [四、在kubernetes上部署我们的微服务][4]
  ...
  [1]: https://github.com/whusj/kubernetes-starter/tree/master/docs/1-pre.md
  [2]: https://github.com/whusj/kubernetes-starter/tree/master/docs/2-kubernetes-simple.md
  [3]: https://github.com/whusj/kubernetes-starter/tree/master/docs/3-kubernetes-with-ca.md
  [4]: https://github.com/whusj/kubernetes-starter/tree/master/docs/4-microservice-deploy.md
